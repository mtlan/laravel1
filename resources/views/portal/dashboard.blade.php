                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-1">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ url('front') }}/assets/images/users/48/avatar-2.jpg"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-1">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ url('front') }}/assets/images/users/48/avatar-7.jpg"
                                                        alt="" class="avatar-sm rounded-circle p-1">
                                                </div>
                                                <div class="flex-grow-1 overflow-hidden">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-1">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ url('front') }}/assets/images/users/48/avatar-4.jpg"
                                                        alt="" class="avatar-sm rounded-circle p-1">
                                                </div>
                                                <div class="flex-grow-1 overflow-hidden">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-1">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ url('front') }}/assets/images/users/48/avatar-5.jpg"
                                                        alt="" class="avatar-sm rounded-circle p-1">
                                                </div>
                                                <div class="flex-grow-1 overflow-hidden">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-1">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ url('front') }}/assets/images/users/48/avatar-6.jpg"
                                                        alt="" class="avatar-sm rounded-circle p-1">
                                                </div>
                                                <div class="flex-grow-1 overflow-hidden">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-1">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ url('front') }}/assets/images/users/48/avatar-1.jpg"
                                                        alt="" class="avatar-sm rounded-circle p-1">
                                                </div>
                                                <div class="flex-grow-1 overflow-hidden">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-1">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ url('front') }}/assets/images/users/48/avatar-8.jpg"
                                                        alt="" class="avatar-sm rounded-circle p-1">
                                                </div>
                                                <div class="flex-grow-1 overflow-hidden">
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                <thead class="text-muted table-light">
                                    <tr>
                                        ...
                                        <th scope="col" class="sort cursor-pointer" data-sort="customer">Customers
                                        </th>
                                ...
                                <tbody class="list">
                                    <tr>
                                        ...
                                        <td class="shop">
                                            <img src="{{ url('front') }}/assets/images/companies/img-7.png"
                                    ...
                                    <tr>
                                        ...
                                        <td class="shop">
                                            <img src="{{ url('front') }}/assets/images/companies/img-1.png"
                                                alt="" class="avatar-xxs rounded-circle">
                                        </td>
                                        <td class="customer">
                                            Jansh Brown
                                    ...
                                    <tr>
                                        ...
                                        <td class="shop">
                                            <img src="{{ url('front') }}/assets/images/companies/img-2.png"
                                                alt="" class="avatar-xxs rounded-circle">
                                        </td>
                                        <td class="customer">
                                            Ayaan Bowen
                                    ...
                                    <tr>
                                        ...
                                        <td class="shop">
                                            <img src="{{ url('front') }}/assets/images/companies/img-3.png"
                                                alt="" class="avatar-xxs rounded-circle">
                                        </td>
                                        <td class="customer">
                                            Prezy Mark
                                    ...
                                    <tr>
                                        ...
                                        <td class="shop">
                                            <img src="{{ url('front') }}/assets/images/companies/img-4.png"
                                                alt="" class="avatar-xxs rounded-circle">
                                        </td>
                                        <td class="customer">
                                            Vihan Hudda
                                    ...
                                    <tr>
                                        ...
                                        <td class="shop">
                                            <img src="{{ url('front') }}/assets/images/companies/img-5.png"
                                                alt="" class="avatar-xxs rounded-circle">
                                        </td>
                                        <td class="customer">
                                            Vihan Hudda
                            ...
                            <div class="noresult" style="display: none">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mb-0">We've searched more than 150+ transactions
                                        We did not find any transactions for you search.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="vstack gap-2">
                                ...
                                <div class="p-2 border border-dashed">
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="avatar-sm flex-shrink-0">
                                            <div class="avatar-title bg-light rounded">
                                                <img src="{{ url('front') }}/assets/images/products/32/img-2.png"
                                                    alt="" class="avatar-xs">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <div class="p-2 border border-dashed">
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="avatar-sm flex-shrink-0">
                                            <div class="avatar-title bg-light rounded">
                                                <img src="{{ url('front') }}/assets/images/products/32/img-3.png"
                                                    alt="" class="avatar-xs">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <div class="p-2 border border-dashed">
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="avatar-sm flex-shrink-0">
                                            <div class="avatar-title bg-light rounded">
                                                <img src="{{ url('front') }}/assets/images/products/32/img-4.png"
                                                    alt="" class="avatar-xs">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <div class="p-2 border border-dashed">
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="avatar-sm flex-shrink-0">
                                            <div class="avatar-title bg-light rounded">
                                                <img src="{{ url('front') }}/assets/images/products/32/img-6.png"
                                                    alt="" class="avatar-xs">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                        ...
                        <div data-simplebar="" class="px-3" style="max-height: 258px;">
                            <div class="acitivity-timeline acitivity-main">
                                ...
                                <div class="acitivity-item py-3 d-flex">
                                    <div class="flex-shrink-0">
                                        <img src="{{ url('front') }}/assets/images/users/32/avatar-2.jpg" alt=""
                                ...
                                <div class="acitivity-item py-3 d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h6 class="mb-1 lh-base">Today offers by <a
                                                ...
                                                Galaxy</a></h6>
                                        <p class="text-muted mb-2">Offer is valid on orders of $230 Or
