                                ...
                                @foreach ($hdvdl_dm_ngon_ngus as $hdvdl_dm_ngon_ngu)
                                    <tr>
                                        <td class="text-center">
                                            <a href="#" wire:click.prevent="view({{ $hdvdl_dm_ngon_ngu->id }})"
                                                style="color: rgb(48, 100, 177); cursor: pointer; text-decoration: underline;">
                                                {{ $hdvdl_dm_ngon_ngu->ten }}
                                            </a>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            @can('edit')
                                                <button class="btn btn-sm btn-success"
                                                    wire:click="edit({{ $hdvdl_dm_ngon_ngu->id }})">Sửa</button>
                                            @endcan
                    ...
                    <form wire:submit.prevent="store">
                        ...
                        <div class="modal-body">
                            <div class="form-group mb-2">
                                <x-label for="tenNgonNgu" field="ten" class="col-3" :required="$this->isRequired('ten')">Tên</x-label>
                                <div class="col-12">
                                    <input type="text" class="form-control" id="tenNgonNgu" wire:model="ten"
                            ...
                            <div class="form-group mb-2">
                                <x-label for="maNgonNgu" field="ma" class="col-3" :required="$this->isRequired('ma')">Mã</x-label>
                                <div class="col-12">
                                    <input type="text" class="form-control" id="maNgonNgu" wire:model="ma"
                            ...
                            <div class="form-group mb-2">
                                <x-label for="trangThaiNgonNgu" field="trangthai" class="col-3" :required="$this->isRequired('trangthai')">Trạng
                                    thái</x-label>
                                <div class="col-12">
                                    <select class="form-select" wire:model="trangthai" id="trangThaiNgonNgu">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form wire:submit.prevent="update" class="mb-2">
                            @csrf
                            <div class="form-group mb-2">
                                <x-label for="tenNgonNgu" field="ten" class="col-3"
                            ...
                            <div class="form-group mb-2">
                                <x-label for="maNgonNgu" field="ma" class="col-3"
                            ...
                            <div class="form-group mb-2">
                                <x-label for="trangThaiNgonNgu" field="trangthai" class="col-3"
